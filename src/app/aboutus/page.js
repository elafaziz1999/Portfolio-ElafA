...
const Team = () => {
  const teamMembers = [
    {
      name: 'Eng. Malik Abdul Aziz',
      title: 'CEO & General Manager Engineering',
      image: '/profile.png',
      socials: [
        {
          color: '#39569c',
    ...
    {
        name: 'Eng. Malik Mohd. Saeed Awan',
        title: 'Co-founder',
        image: '/profile.png',
        socials: [
          {
      ...
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
        <div className="mx-auto mb-8 max-w-screen-sm lg:mb-16">
          ...
          <p className="font-light text-gray-500 sm:text-xl dark:text-gray-400">
            Get to know the faces behind our company and learn more about the talented individuals who make Buraq Contracting Co. a
            leader in Electrical Engineering and Construction. Together, we’re building a brighter future and making a lasting impact.
          </p>
        </div>
